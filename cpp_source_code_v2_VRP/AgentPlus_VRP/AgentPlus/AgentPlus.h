...
#define _MAX_NUMBER_OF_LINKS 70000
#define _MAX_NUMBER_OF_TIME_INTERVALS 1400

#define _MAX_NUMBER_OF_VEHICLES 100
#define _MAX_NUMBER_OF_PASSENGERS 1000
#define _MAX_NUMBER_OF_SERVED_PASSENGERS 210

#define _MAX_NUMBER_OF_STATES 300

#define _PENALTY_OF_NOT_DELIVERY 300
extern int g_number_of_physical_vehicles;
extern int g_number_of_passengers;


#define _MAX_NUMBER_OF_OUTBOUND_NODES 500
...
public:
	...
	bool AddProhibitedAssignment(int p, std::vector <int> prohibited_vehicle_id_vector, int new_vehicle_id)
	{

		V2PAssignmentVector[p].input_prohibited_vehicle_id_vector = prohibited_vehicle_id_vector;// inherit the parent's prohibitted vehicle ids for this p
		V2PAssignmentVector[p].input_prohibited_vehicle_id_vector.push_back(new_vehicle_id);  //add a new vehicle id into the list
		return true;
	}
	bool reset_output()
	{
