...
origin_node_v('1','7','1','0') = 1;
parameter destination_node_v(k,i,t,w); destination_node_v('1','7','30','0') = 1; 
...
origin_node_p('1','1') = 1; 
origin_node_p('2','4') = 1; 
parameter destination_node_p(p,a);destination_node_p('1','1') = 1;
